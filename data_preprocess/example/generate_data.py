...
def test_nested_ner():
    source_file_path = os.path.join(ROOT_PATH, "data_preprocess/example/dev_ace05.json")
    target_file_path = os.path.join(ROOT_PATH, "data_preprocess/example/mrc-dev_ace05.json")
    entity_sign = "nested"
...
def test_flat_ner():
    ...
    source_file_path = os.path.join(ROOT_PATH, "data_preprocess/example/ace05/train1.bsme")
    target_file_path = os.path.join(ROOT_PATH, "data_preprocess/example/ace05/train1.bsme.json")
    entity_sign = "flat"
    dataset_name = "en_ace2005"
    query_sign = "default"
    generate_query_ner_dataset(source_file_path, target_file_path, entity_sign=entity_sign, dataset_name=dataset_name, query_sign=query_sign)
