...
path_en_ontonotes = os.path.join(root_path, "data_preprocess/queries/en_ontonotes.json")
...
query_en_ontonotes = load_query_map(path_en_ontonotes)
...
queries_for_dataset = {
   ...
   "en_ontonotes": query_en_ontonotes,
